# Currently, this is only a clone of the more specific script that I originally 
# wrote for LaunchBox. In the future, this will be a more generic script 
# that can be used for any app with any accessibility settings.
# But I would very much like advice on how to do that.
