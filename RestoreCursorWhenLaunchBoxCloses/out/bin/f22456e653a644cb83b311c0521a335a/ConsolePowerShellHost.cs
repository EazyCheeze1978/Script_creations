...
namespace PowerShellToolsPro.Packager.ConsoleHost
{
    class Program
    {
        ...
        static int Main(string[] args)
        {
            ...
            if (WriteResourceToFile("RestoreCursorWhenLaunchBoxCloses.Modules.zip", moduleZip))
            {
            ...
            String script;
            using (var stream = Assembly.GetExecutingAssembly().GetManifestResourceStream("RestoreCursorWhenLaunchBoxCloses.script.ps1"))
            {
        ...
        private static string Decrypt(string cipherString)
        {
            ...
            string key = "ea2a4f73-f8de-4a6d-a4c1-";
